...
import 'package:kooha_test/widgets/toast_text.dart';
    ...
    return Scaffold(
        ...
        child: Column(
          children: <Widget>[
            Row(
                ...
                children: <Widget>[
                  SvgPicture.asset("assets/svgs/navigation.svg"),
                  Container(
            ...
            AppTextField(
              ...
              hasBorder: true,
              isSearch: false,
              hintText: "justinculhane@gmail.com",
              onChanged: (val) {
                validateEmail(val);
              },
              suffixIcon: Padding(
                ...
                RichText(
                  text: const TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(
                          text: "Privacy Policy ",
                          style: TextStyle(color: kGoldenYellow)),
                      TextSpan(
                          text: '& ',
                          style: TextStyle(color: Color(0xFFAAAAAA))),
                      TextSpan(
      ...
      floatingActionButton: Padding(
        ...
        child: AppButton(
          ...
          text: 'Create account',
          onTap: email.text.isNotEmpty &&
                  nameEd.text.isNotEmpty &&
