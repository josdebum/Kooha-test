  ...
  Widget build(BuildContext context) {
    ...
    return    Scaffold(
      ...
      return NavigationWidget();
        ...
        style:  TextStyle(fontSize: 14,fontFamily: "Satoshi", fontWeight: FontWeight.w500, color: kWhite2))),
        backgroundColor: kBlack3,
            ...
            body: SafeArea(
              child: DefaultTabController(
                ...
                child: Column(
                  ...
                  ButtonsTabBar(
                      buttonMargin: const EdgeInsets.only(right: 8, top: 4, bottom: 4, left: 8),
                      radius: 30,
                ...
                color: kGoldenYellow),
                      ...
                      labelStyle:
                      const TextStyle(color: kBlack3,fontFamily: "Satoshi", fontWeight: FontWeight.w500, fontSize: 14),
                      tabs: const [
                        Tab(
                    ...
                    const Divider(thickness: 0.5, color: kTextGrey3,).addHeight(24.h),
                    Expanded(
                      child: TabBarView(
                        children: <Widget>[
                         notifications(),
                          ...
                          const Center(
                              child:  Text("No Notification",
                                style: TextStyle(color: kWhite2,
                                    fontFamily: "Satoshi", fontWeight: FontWeight.w500, fontSize: 14),)
                          ),
        ...
        child: Column(children: <Widget>[
          ...
          const Align(
              ...
              child:Text("Today", style: TextStyle(
                fontFamily: "Satoshi",
                  fontWeight: FontWeight.w700, fontSize: 16, color: kTextGrey3  ),)).addHeight(24.h),

          const UpdateContainer(),
          const Divider(color: kTextGrey3, thickness: 0.5,),
          ...
          const Divider(color: kTextGrey3, thickness: 0.5,).addHeight(24.h),

          const Align(
              alignment: Alignment.topLeft,
              child:Text("Yesterday", style: TextStyle(
                fontFamily: "Satoshi",
                  fontWeight: FontWeight.w700, fontSize: 16, color: kTextGrey3  ),)),
